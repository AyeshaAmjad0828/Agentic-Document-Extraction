...
#     ] 
#     }
#     prompt = document_extractor_agent(invoice,schema)
#     generated_output = {
...
#     state = [0.3, 0.4]  # Example exact match and similarity scores
#     for action_id in range(5):
#         new_prompt = adjust_prompt(prompt, task_type, state, action_id, generated_output, groundtruth)
#         print(f"Action {action_id}: {new_prompt}")
